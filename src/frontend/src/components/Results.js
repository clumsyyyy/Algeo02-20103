        ...
        <div id = "Results" className = "Results" hidden>
            ...
            <div className = "containers">
                ...
                <div className = "scale-input">
                    ...
                    <input className = "scale" id = "scale" type = "number" placeholder = "Enter image scale... (1-100)" required min = "0" max = "100" defaultValue = "100"></input>
                ...
                <div className = "iter-input">
                    ...
                    <input className = "iter" id = "iter" type = "number" placeholder = "Enter iteration number... (2-100)" required min = "0" max = "100" defaultValue = "2"></input>
